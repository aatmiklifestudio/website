...
import { Facebook, Linkedin, MessageSquare, ChevronLeft, ChevronRight, Play } from "lucide-react"
...
export default function Home() {
  ...
  const [emblaRef, emblaApi] = useEmblaCarousel({
    ...
    align: "start",
    dragFree: true
  }, [AutoScroll({ speed: 0.5, stopOnInteraction: false, stopOnMouseEnter: false }) as any]);

  const handleVideoClick = (num: number, index: number) => {
    ...
    if (playingVideo === num) {
      ...
      if (autoScroll) (autoScroll as any).stop();
      if (playingVideo !== null) {
        const prevIndex = [1, 2, 3, 4, 5].indexOf(playingVideo);
        if (prevIndex !== -1 && videoRefs.current[prevIndex]) {
  ...
  return (
    <div className="min-h-screen bg-[rgb(235, 240, 225)]">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="mb-4 text-sm leading-relaxed">
                I am Sushma Malik, founder of Aatmik Life Studio and a certified wellness coach, recognized internationally and by AYUSH for my expertise in yoga.
              </p>

              <p className="mb-4 text-sm leading-relaxed">
                With over a decade of experience, I have had the privilege of collaborating with esteemed organizations such as Air Force Family Welfare Association and Navy Wives Welfare Association to promote holistic well-being and empowerment. Additionally, I am a proud member of Business Network International (BNI).
              </p>

              <p className="text-sm leading-relaxed">
                Through my multifaceted expertise, I strive to create a supportive environment for individuals on their journey to holistic well-being. I blend traditional yoga practices with modern techniques to guide individuals toward physical and mental harmony, along with natural healing methods into my sessions, promoting overall wellness. I offer online & off-line yoga sessions, wellness counseling, weight management therapy and holistic wellness retreats.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white overflow-hidden">
        <div className="container mx-auto px-4">
          <h2 className="mb-12 text-4xl font-light text-center" style={headingStyle}>Stories of Transformation</h2>

          <div className="mb-20">
            <div className="overflow-hidden" ref={emblaRef}>
              <div className="flex -ml-4 lg:-ml-8">
                {[1, 2, 3, 4, 5].map((num, index) => (
                  <div key={num} className="flex-[0_0_80%] min-w-0 pl-4 lg:pl-8 sm:flex-[0_0_50%] md:flex-[0_0_33.33%] lg:flex-[0_0_25%]">
                    <div
                      className="relative aspect-[9/16] overflow-hidden rounded-md bg-gray-50 shadow-sm border border-gray-100 cursor-pointer group"
                      onClick={() => handleVideoClick(num, index)}
                    >
                      <video
                        ref={(el) => {
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            <div>
              ...
              <p className="mt-4 text-sm">Enigma Indiabulls, Gurgaon</p>
            </div>
          ...
          <div className="mt-16 text-right text-xs text-gray-600">
            © 2026 by Aatmik Life Studio. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
